...
local function WorldCFrameToC0ObjectSpace(motor6DJoint: Motor6D, worldCFrame: CFrame)
	if not motor6DJoint or not motor6DJoint.Part1 or not motor6DJoint.Part0 or not worldCFrame then return end
