...
local UnreliableRemoteEventName = require(ReplicatedStorage.Common.Network.RemoteName.UnreliableRemoteEventName)
local BindableEventName = require(ReplicatedStorage.Common.Network.RemoteName.BindableEventName)
