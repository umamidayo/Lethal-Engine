...
-- Animation
local Animations = ReplicatedStorage:WaitForChild("Animations"):WaitForChild("Weapons"):WaitForChild("Baseball Bat")
local AnimationTracks = {}
local currentStyle = "Reckless"
...
local function ChangeStyle(Animator: Animator)
	currentStyle = currentStyle == "Finisher" and "Reckless" or "Finisher"
