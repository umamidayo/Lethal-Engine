...
return function(Vargs)
	...
	server.Commands.GiveCash = {
		Prefix = server.Settings.Prefix, -- Prefix to use for command
		Commands = { "givecash" }, -- Commands
		Args = { "amount" }, -- Command arguments
		Description = "Gives cash to you.", -- Command Description
		...
		Function = function(plr: Player, args) -- Function to run for command
			...
			PlayerService.incrementStat(plr, "Cash", tonumber(args[1]))
		end,
	}
end
