...
self.RArmCFrame 	= CFrame.new(0.05,-0.15,0.6) * CFrame.Angles(math.rad(90),math.rad(0),math.rad(0))
...
self.ReloadAnim = function(objs)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.2,-0.65,0.6) * CFrame.Angles(math.rad(115),math.rad(-15),math.rad(0))):inverse() }):Play()
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.4,-2,-0.5) * CFrame.Angles(math.rad(120),math.rad(-15),math.rad(30))):inverse() }):Play()
	wait(.1)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.2,-0.55,0.6) * CFrame.Angles(math.rad(110),math.rad(-15),math.rad(0))):inverse() }):Play()
	...
	wait(.1)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.2,-0.65,0.6) * CFrame.Angles(math.rad(115),math.rad(-15),math.rad(0))):inverse() }):Play()
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.4,-0.2,-0.4) * CFrame.Angles(math.rad(120),math.rad(-15),math.rad(30))):inverse() }):Play()
...
self.PumpAnim = function(objs)
	wait(.2)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.05,-0.15,0.6) * CFrame.Angles(math.rad(90),math.rad(0),math.rad(0))):inverse() }):Play()
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.6,-0.25,-1) * CFrame.Angles(math.rad(110),math.rad(15),math.rad(15))):inverse() }):Play()
	TS:Create(objs[4].Handle.Bolt, TweenInfo.new(.25,Enum.EasingStyle.Sine), {C0 =  CFrame.new():inverse() }):Play()
	wait(.2)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.05,-0.15,0.6) * CFrame.Angles(math.rad(90),math.rad(0),math.rad(0))):inverse() }):Play()
