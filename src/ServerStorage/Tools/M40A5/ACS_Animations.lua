...
self.TacticalReloadAnim = function(objs)
	...
	TS:Create(objs[1], TweenInfo.new(.17,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.275,0.05,.9) * CFrame.Angles(math.rad(120),math.rad(0),math.rad(0))):inverse() }):Play()
	TS:Create(objs[4].Handle.Bolt, TweenInfo.new(.1,Enum.EasingStyle.Sine), {C0 =  CFrame.new():inverse() }):Play()	
	wait(.17)
	TS:Create(objs[1], TweenInfo.new(.17,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.275,-0.4,.9) * CFrame.Angles(math.rad(120),math.rad(0),math.rad(0))):inverse() }):Play()
	wait(.17)
	TS:Create(objs[1], TweenInfo.new(.17,Enum.EasingStyle.Sine), {C1 = self.RArmCFrame:Inverse()}):Play()
	wait(.17)
...
self.PumpAnim = function(objs)
	...
	TS:Create(objs[1], TweenInfo.new(.1,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.275,-0.35,.9) * CFrame.Angles(math.rad(175),math.rad(0),math.rad(0))):inverse() }):Play()
	TS:Create(objs[4].Handle.Bolt, TweenInfo.new(.1,Enum.EasingStyle.Sine), {C0 =  CFrame.new(0,0,-0.3):inverse() }):Play()	
	
	wait(.12)

	objs[4].Bolt.SlideRelease:Play()
	TS:Create(objs[1], TweenInfo.new(.1,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.275,0.05,.9) * CFrame.Angles(math.rad(120),math.rad(0),math.rad(0))):inverse() }):Play()
